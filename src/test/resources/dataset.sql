...
insert into producto values (2, "AUTORIZADO", "color cafe", "2023-04-01 10:10:05", "2023-08-01 10:10:05", "Patines", 100000, 10, 1);
insert into producto values (3, "DENEGADO", "color rosado", "2023-04-15 22:10:05", "2023-06-15 22:10:05", "Balon", 10000, 20, 2);
insert into producto values (4, "AUTORIZADO", "material: Carton", "2023-04-02 13:10:05", "2023-08-20 13:10:05", "rascador", 25000, 15, 3);
insert into producto values (5, "DENEGADO", "color azul", "2023-03-02 13:10:05", "2023-09-01 13:10:05", "Pantalon", 53000, 25, 5);
...
insert into producto_moderador values (2, "AUTORIZADO", "2023-04-06 10:10:05", "producto ok", 5, 2);
insert into producto_moderador values (3, "DENEGADO", "2023-04-16 22:10:05", "imagen borrosa", 3, 3);
insert into producto_moderador values (4, "AUTORIZADO", "2023-04-03 13:10:05", "producto ok", 2, 4);
insert into producto_moderador values (5, "DENEGADO", "2023-03-03 13:10:05", "descripcion no valida", 4, 5);

insert into compra values (1, "2023-04-15 13:10:05", "VISA", 200000, 4);
insert into compra values (2, "2023-04-19 13:10:05", "MASTERCARD", 400000, 4);
insert into compra values (3, "2023-04-15 13:10:05", "VISA", 500000, 2);
insert into compra values (4, "2023-03-15 13:10:05", "MASTERCARD", 80000, 1);
insert into compra values (5, "2023-04-15 13:10:05", "VISA", 90000, 2);
...
insert into comentario values (1, "2023-04-17 13:12:05", "me encanta", 4, 2);
insert into comentario values (2, "2023-04-18 13:10:05", "me gustaria en otros colores", 1, 3);
insert into comentario values (3, "2023-04-17 13:10:05", "me encanta", 2, 2);
insert into comentario values (4, "2023-04-18 13:11:05", "me gusta", 1, 4);
insert into comentario values (5, "2023-04-19 15:10:05", "me encanta", 2, 5);

insert into queja values (1, "Llego la cantidad incorrecta", "2023-04-19 13:10:05", 3);
insert into queja values (2, "No puedo cambiar la contraseña", "2023-04-17 13:10:05", 1);
insert into queja values (3, "El cobro es incorrecto", "2023-04-16 13:10:05", 4);
insert into queja values (4, "Llego en color diferente", "2023-04-17 13:15:05", 2);
insert into queja values (5, "No me deja agregar favoritos", "2023-04-18 13:10:05", 1);
